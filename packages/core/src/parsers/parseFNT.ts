...
import { Font, FontGlyph, fontInit } from '../entities/font';

export function parseFNT(data: string): Font {
  ...
  return fontInit(lineHeight, texture, [textureWidth, textureHeight], glyphs);
}
